...
public class Employee extends Person implements BoardingPassGenerator  {
    ...
    public boolean checkForBoarding() {
        try {
          java.awt.Desktop.getDesktop().open(new java.io.File("output/outputPLACEHOLDERS.pdf"));
    ...
    public void varsToPDF(Reservation reservation) {
        String templatePath = "resources/BoardingPassTemplateReal.pdf";
        String outputPath = "output/outputPLACEHOLDERS.pdf";
